...
import { GridContainerStyled, GridStyled, OutlinedInputStyled, TitleStyled, TopicImageStyled } from './styles';
            ...
            <Grid item xs={6}>
                ...
                <GridContainerStyled container rowGap={4}>
                    ...
                    <Grid container columnSpacing={3} rowSpacing={3}>
                        <Grid item xs={12}>
                            <Button fullWidth size='large' variant='contained' onClick={handleSignup}>CREATE YOUR RESTAURANT</Button>
                        </Grid>
                        <Grid item xs={12}>
                            <Typography variant='subtitle1'>Already a member? <Link>Click here to sign in</Link></Typography>
                        </Grid>
                    </Grid>
                </GridContainerStyled>
            </Grid>
